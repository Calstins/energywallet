    ...
    <PageTransition>
      <div className="pt-[88px] min-h-screen bg-white">
        <div className="max-w-[1200px] mx-auto px-6 py-16">
          ...
          >
            {[
              { icon: '/icon-smart-wallet.svg', title: 'Smart Wallets', desc: 'Organize your funds with dynamic sub-wallets designed for your specific spending habits and savings goals.' },
              { icon: '/icon-one-shop.svg', title: 'One-Stop Shop', desc: 'Access a curated marketplace of verified Nigerian vendors directly within the app for seamless transactions.' },
              { icon: '/icon-easy-payment.svg', title: 'Easy Payments', desc: 'Settle bills in seconds with our high-velocity payment engine, built for the pace of urban Nigerian life.' },
            ].map((f, i) => (
              <motion.div
                key={f.title}
              ...
              >
                ...
                <h3 className="font-headline font-extrabold text-[#0D0D0D] text-lg">{f.title}</h3>
